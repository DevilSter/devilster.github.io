 ...
 */
external interface UiReactHtmlElementEvents : RProps {
    ...
    var onTouchCancel: ((UiTouchEvent) -> Unit)?
    var onTouchEnd: ((UiTouchEvent) -> Unit)?
    var onTouchMove: ((UiTouchEvent) -> Unit)?
    var onTouchStart: ((UiTouchEvent) -> Unit)?
